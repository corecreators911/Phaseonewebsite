import{r as w,j as h}from"./index-CRuJD0Dd.js";import{S as g,O as y,W as z,a as b,V as R,P as k,M as C,C as E}from"./vendor-three-CQgtocpM.js";import"./vendor-react-labSKdyf.js";import"./vendor-gsap-DDlvirwQ.js";import"./vendor-motion-pOD7n95U.js";const W=()=>{const n=w.useRef(null);return w.useEffect(()=>{if(!n.current)return;const r=new g,s=new y(-1,1,1,-1,.1,10);s.position.z=1;let e;try{e=new z({alpha:!0,antialias:!1}),e.setSize(window.innerWidth,window.innerHeight),e.setPixelRatio(Math.min(window.devicePixelRatio,2)),n.current.appendChild(e.domElement)}catch{console.warn("WebGL not supported, skipping shader background");return}const t={uTime:{value:0},uMouse:{value:new R(.5,.5)}},a=new b({uniforms:t,vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
